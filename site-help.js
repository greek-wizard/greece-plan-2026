(() => {
  ...
  styles.textContent = `
    .site-help-button{flex:0 0 auto;width:32px;height:32px;display:grid;place-items:center;border:1px solid #ffffff38;border-radius:50%;background:#ffffff0e;color:#fff;font-weight:900;cursor:pointer}.site-help-button:hover,.site-help-button:focus-visible{background:#fff;color:var(--navy,#102d33);outline:0}.site-help-dialog{width:min(720px,calc(100vw - 28px));max-height:min(820px,88dvh);border:0;border-radius:20px;padding:0;background:#fffefa;color:#17363a;box-shadow:0 30px 100px #071a1e70}.site-help-dialog::backdrop{background:#071a1e99;backdrop-filter:blur(3px)}.site-help-sheet{padding:24px}.site-help-head{display:flex;justify-content:space-between;align-items:start;gap:18px}.site-help-head h2{margin:0;font:2rem/1 Georgia,serif}.site-help-head p{margin:9px 0 0;max-width:570px;color:#687a7c;line-height:1.5}.site-help-close{flex:0 0 auto;width:40px;height:40px;border:0;border-radius:50%;background:#edf2ef;color:#17363a;font-size:1.25rem;cursor:pointer}.site-help-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:9px;margin:20px 0}.site-help-item{display:grid;grid-template-columns:34px 1fr;gap:10px;border:1px solid #d9e0dc;border-radius:13px;padding:13px;background:#fff}.site-help-icon{width:34px;height:34px;display:grid;place-items:center;border-radius:10px;background:#e7f1ef;color:#176f7c;font-weight:900}.site-help-item b{display:block;margin:1px 0 3px}.site-help-item span{display:block;color:#687a7c;font-size:.78rem;line-height:1.4}.site-help-foot{display:flex;align-items:center;justify-content:space-between;gap:16px;border-top:1px solid #d9e0dc;padding-top:16px}.site-help-foot small{max-width:430px;color:#687a7c;line-height:1.4}.site-help-primary{border:0;border-radius:10px;background:#176f7c;color:#fff;padding:11px 16px;font-weight:850;cursor:pointer;white-space:nowrap}
  ...
  dialog.innerHTML = `
    <div class="site-help-sheet">
      ...
      <div class="site-help-grid">
        ...
        <div class="site-help-item"><span class="site-help-icon">2</span><div><b>Przechodź między dniami</b><span>Timeline prowadzi do wybranej daty. Na telefonie otwarty pozostaje tylko jeden dzień.</span></div></div>
