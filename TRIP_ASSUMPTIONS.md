...
- The main page shows only the current detailed day-by-day itinerary. The separate `excursions.html` page is the option-selection surface; each option states approximate round-trip distance from Tolo, driving time, total duration, pace, and its main trade-off.
