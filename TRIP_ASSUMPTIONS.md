...
- The current main page prioritizes a selectable day-trip catalogue over a route map. Each option must state approximate round-trip distance from Tolo, driving time, total duration, pace, and its main trade-off.
